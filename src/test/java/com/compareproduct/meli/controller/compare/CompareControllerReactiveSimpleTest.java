...
@DisplayName("CompareController Reactive Unit Tests")
@ExtendWith(MockitoExtension.class)
class CompareControllerReactiveSimpleTest {

    @Mock
    private CompareService compareService;

    @InjectMocks
    private CompareController testCompareController;
    ...
    void shouldCompareProductsSuccessfully() {
        ...
        // When
        Mono<CompareResponse> result = testCompareController.compareProducts(request);
